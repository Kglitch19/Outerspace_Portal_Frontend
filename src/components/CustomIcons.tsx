...
export function CheckBoxOutlineBlankRoundedIcon(props) {
  return (
    <SvgIcon {...props}>
      {/* SVG path for CheckBoxOutlineBlankRoundedIcon */}
    </SvgIcon>
  );
}

export function CheckRoundedIcon(props) {
  return (
    <SvgIcon {...props}>
      {/* SVG path for CheckRoundedIcon */}
    </SvgIcon>
  );
}

export function RemoveRoundedIcon(props) {
  return (
    <SvgIcon {...props}>
      {/* SVG path for RemoveRoundedIcon */}
    </SvgIcon>
  );
}

export const SriLankaFlag = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 16"
    width="24"
    height="16"
  >
    <rect width="24" height="16" fill="#FFB400" />
    <rect width="24" height="8" fill="#C8102E" />
    <path
      d="M12 0l-1.5 1.5L12 3l1.5-1.5L12 0zm0 16l1.5-1.5L12 13l-1.5 1.5L12 16z"
      fill="#C8102E"
    />
    <path
      d="M6 8h12v2H6zm0 4h12v2H6z"
      fill="#C8102E"
    />
    <path
      d="M0 0h24v16H0z"
